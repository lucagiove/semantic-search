...
} from "../../src/infrastructure/pdf-extractor.js";
...
describe("PdfParseTextExtractor", () => {
  ...
  it("maps missing files to a FILE_NOT_FOUND error", async () => {
    ...
    await expect(extractor.extractPages("docs/missing.pdf")).rejects.toEqual(
      new CliError("FILE_NOT_FOUND", "PDF file not found: docs/missing.pdf", {
